...
<div class="alert alert-warning" role="alert">
  <strong>Hinweis!</strong> Für die Verwendung der Stable Firmware gilt: Aktuelle Ubiquiti Geräte, welche mit Firmwareversion 5.6.x geliefert werden, müssen erst auf 5.5.x downgraded werden. Wird dies nicht getan, kann die FFMuc Firmware das Gerät dauerhaft unbrauchbar machen. Eine detaillierte Anleitung zum Vorgehen findet sich im <a href="https://wiki.md.freifunk.net/Anleitungen/router-flashen-ubnt">Freifunk Magdeburg Wiki</a>.<br>
  Bei Verwendung unserer experimental Firmware v2015.7-78-gf36fbda, die gluon 2016.1.5 verwendet, ist das laut <a href="https://gluon.readthedocs.io/en/v2016.1.5/releases/v2016.1.5.html">Changelog zu Gluon 2016.1.5</a> nicht mehr notwendig.
</div>
